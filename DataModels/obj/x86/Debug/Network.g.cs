namespace DataModels
{
   ...
   public static partial class Network_Root
   {
      ...
      static Network_Root()
      {
         ...
         ConstructorMap.Add("#InterfaceEncap", args => MkUserCnst(Network_Root.TypeCnstKind.InterfaceEncap));
         ConstructorMap.Add("#InterfaceEncap[0]", args => MkUserCnst(Network_Root.TypeCnstKind.InterfaceEncap_NDEX_0));
         ConstructorMap.Add("#InterfaceEncap[1]", args => MkUserCnst(Network_Root.TypeCnstKind.InterfaceEncap_NDEX_1));
         ...
         ConstructorMap.Add("#Interface[2]", args => MkUserCnst(Network_Root.TypeCnstKind.Interface_NDEX_2));
         ...
         ConstructorMap.Add("#PortMode", args => MkUserCnst(Network_Root.TypeCnstKind.PortMode));
         ...
         ConstructorMap.Add("#SwitchPortTrunkAllowedVlan", args => MkUserCnst(Network_Root.TypeCnstKind.SwitchPortTrunkAllowedVlan));
         ConstructorMap.Add("#SwitchPortTrunkAllowedVlan[0]", args => MkUserCnst(Network_Root.TypeCnstKind.SwitchPortTrunkAllowedVlan_NDEX_0));
         ConstructorMap.Add("#SwitchPortTrunkAllowedVlan[1]", args => MkUserCnst(Network_Root.TypeCnstKind.SwitchPortTrunkAllowedVlan_NDEX_1));
         ...
         ConstructorMap.Add("#_connects", args => MkUserCnst(Network_Root.TypeCnstKind._connects));
         ConstructorMap.Add("#_connects[0]", args => MkUserCnst(Network_Root.TypeCnstKind._connects_NDEX_0));
         ConstructorMap.Add("#_connects[1]", args => MkUserCnst(Network_Root.TypeCnstKind._connects_NDEX_1));
         ConstructorMap.Add("#_connects[2]", args => MkUserCnst(Network_Root.TypeCnstKind._connects_NDEX_2));
         ConstructorMap.Add("#connectVlan", args => MkUserCnst(Network_Root.TypeCnstKind.connectVlan));
         ConstructorMap.Add("#connectVlan[0]", args => MkUserCnst(Network_Root.TypeCnstKind.connectVlan_NDEX_0));
         ConstructorMap.Add("#connectVlan[1]", args => MkUserCnst(Network_Root.TypeCnstKind.connectVlan_NDEX_1));
         ConstructorMap.Add("#connects", args => MkUserCnst(Network_Root.TypeCnstKind.connects));
         ConstructorMap.Add("#connects[0]", args => MkUserCnst(Network_Root.TypeCnstKind.connects_NDEX_0));
         ConstructorMap.Add("#connects[1]", args => MkUserCnst(Network_Root.TypeCnstKind.connects_NDEX_1));
         ConstructorMap.Add("#connects[2]", args => MkUserCnst(Network_Root.TypeCnstKind.connects_NDEX_2));
         ConstructorMap.Add("#device", args => MkUserCnst(Network_Root.TypeCnstKind.device));
         ...
         ConstructorMap.Add("#l2Edge", args => MkUserCnst(Network_Root.TypeCnstKind.l2Edge));
         ConstructorMap.Add("#l2Edge[0]", args => MkUserCnst(Network_Root.TypeCnstKind.l2Edge_NDEX_0));
         ConstructorMap.Add("#l2Edge[1]", args => MkUserCnst(Network_Root.TypeCnstKind.l2Edge_NDEX_1));
         ConstructorMap.Add("#l2Edge[2]", args => MkUserCnst(Network_Root.TypeCnstKind.l2Edge_NDEX_2));
         ConstructorMap.Add("#l2Path", args => MkUserCnst(Network_Root.TypeCnstKind.l2Path));
         ConstructorMap.Add("#l2Path[0]", args => MkUserCnst(Network_Root.TypeCnstKind.l2Path_NDEX_0));
         ConstructorMap.Add("#l2Path[1]", args => MkUserCnst(Network_Root.TypeCnstKind.l2Path_NDEX_1));
         ConstructorMap.Add("#l2Path[2]", args => MkUserCnst(Network_Root.TypeCnstKind.l2Path_NDEX_2));
         ...
         ConstructorMap.Add("#sameLan[2]", args => MkUserCnst(Network_Root.TypeCnstKind.sameLan_NDEX_2));
         ConstructorMap.Add("#trunkLink", args => MkUserCnst(Network_Root.TypeCnstKind.trunkLink));
         ConstructorMap.Add("#trunkLink[0]", args => MkUserCnst(Network_Root.TypeCnstKind.trunkLink_NDEX_0));
         ConstructorMap.Add("#trunkLink[1]", args => MkUserCnst(Network_Root.TypeCnstKind.trunkLink_NDEX_1));
         ConstructorMap.Add("#trunkLink[2]", args => MkUserCnst(Network_Root.TypeCnstKind.trunkLink_NDEX_2));
         ConstructorMap.Add("#trunkLink[3]", args => MkUserCnst(Network_Root.TypeCnstKind.trunkLink_NDEX_3));
         ConstructorMap.Add("#vlanDatabase", args => MkUserCnst(Network_Root.TypeCnstKind.vlanDatabase));
         ConstructorMap.Add("#vlanDatabase[0]", args => MkUserCnst(Network_Root.TypeCnstKind.vlanDatabase_NDEX_0));
         ConstructorMap.Add("#vlanDatabase[1]", args => MkUserCnst(Network_Root.TypeCnstKind.vlanDatabase_NDEX_1));
         ConstructorMap.Add("#vlanDatabase[2]", args => MkUserCnst(Network_Root.TypeCnstKind.vlanDatabase_NDEX_2));
         ConstructorMap.Add("#vlanDatabase[3]", args => MkUserCnst(Network_Root.TypeCnstKind.vlanDatabase_NDEX_3));
         ConstructorMap.Add("ACCESS", args => MkUserCnst(Network_Root.UserCnstKind.ACCESS));
         ...
         ConstructorMap.Add("Interface", args => Network_Root.MkInterface((Network_Root.IArgType_Interface__0)args[0], (Network_Root.IArgType_Interface__1)args[1], (Network_Root.IArgType_Interface__2)args[2]));
         ConstructorMap.Add("InterfaceEncap", args => Network_Root.MkInterfaceEncap((Network_Root.IArgType_InterfaceEncap__0)args[0], (Network_Root.IArgType_InterfaceEncap__1)args[1]));
         ...
         ConstructorMap.Add("SwitchPortTrunkAllowedVlan", args => Network_Root.MkSwitchPortTrunkAllowedVlan((Network_Root.IArgType_SwitchPortTrunkAllowedVlan__0)args[0], (Network_Root.IArgType_SwitchPortTrunkAllowedVlan__1)args[1]));
         ...
         ConstructorMap.Add("TRUNK", args => MkUserCnst(Network_Root.UserCnstKind.TRUNK));
         ...
         ConstructorMap.Add("_connects", args => Network_Root.Mk_connects((Network_Root.IArgType__connects__0)args[0], (Network_Root.IArgType__connects__1)args[1], (Network_Root.IArgType__connects__2)args[2]));
         ConstructorMap.Add("connectVlan", args => Network_Root.MkconnectVlan((Network_Root.IArgType_connectVlan__0)args[0], (Network_Root.IArgType_connectVlan__1)args[1]));
         ConstructorMap.Add("connects", args => Network_Root.Mkconnects((Network_Root.IArgType_connects__0)args[0], (Network_Root.IArgType_connects__1)args[1], (Network_Root.IArgType_connects__2)args[2]));
         ...
         ConstructorMap.Add("l2Edge", args => Network_Root.Mkl2Edge((Network_Root.IArgType_l2Edge__0)args[0], (Network_Root.IArgType_l2Edge__1)args[1], (Network_Root.IArgType_l2Edge__2)args[2]));
         ConstructorMap.Add("l2Path", args => Network_Root.Mkl2Path((Network_Root.IArgType_l2Path__0)args[0], (Network_Root.IArgType_l2Path__1)args[1], (Network_Root.IArgType_l2Path__2)args[2]));
         ...
         ConstructorMap.Add("sameLan", args => Network_Root.MksameLan((Network_Root.IArgType_sameLan__0)args[0], (Network_Root.IArgType_sameLan__1)args[1], (Network_Root.IArgType_sameLan__2)args[2]));
         ConstructorMap.Add("trunkLink", args => Network_Root.MktrunkLink((Network_Root.IArgType_trunkLink__0)args[0], (Network_Root.IArgType_trunkLink__1)args[1], (Network_Root.IArgType_trunkLink__2)args[2], (Network_Root.IArgType_trunkLink__3)args[3]));
         ConstructorMap.Add("vlanDatabase", args => Network_Root.MkvlanDatabase((Network_Root.IArgType_vlanDatabase__0)args[0], (Network_Root.IArgType_vlanDatabase__1)args[1], (Network_Root.IArgType_vlanDatabase__2)args[2], (Network_Root.IArgType_vlanDatabase__3)args[3]));
         ...
         ConstructorMap.Add("~rel~InterfaceEncap", args => Network_Root.Mk_CG_rel_CG_InterfaceEncap((Network_Root.IArgType__CG_rel_CG_InterfaceEncap__0)args[0]));
         ...
         ConstructorMap.Add("~rel~SwitchPortTrunkAllowedVlan", args => Network_Root.Mk_CG_rel_CG_SwitchPortTrunkAllowedVlan((Network_Root.IArgType__CG_rel_CG_SwitchPortTrunkAllowedVlan__0)args[0]));
         ...
         ConstructorMap.Add("NetworkTopology.multilink", args => MkUserCnst(Network_Root.NetworkTopology.UserCnstKind.multilink));
         ...
         ConstructorMap.Add("Vlan.#Any", args => MkUserCnst(Network_Root.Vlan.TypeCnstKind.Any));
         ConstructorMap.Add("Vlan.#Constant", args => MkUserCnst(Network_Root.Vlan.TypeCnstKind.Constant));
         ConstructorMap.Add("Vlan.#Data", args => MkUserCnst(Network_Root.Vlan.TypeCnstKind.Data));
         ConstructorMap.Add("Vlan.conforms", args => MkUserCnst(Network_Root.Vlan.UserCnstKind.conforms));
         ConstructorMap.Add("Vlan.notFunctional", args => MkUserCnst(Network_Root.Vlan.UserCnstKind.notFunctional));
         ConstructorMap.Add("Vlan.notInjective", args => MkUserCnst(Network_Root.Vlan.UserCnstKind.notInjective));
         ConstructorMap.Add("Vlan.notInvTotal", args => MkUserCnst(Network_Root.Vlan.UserCnstKind.notInvTotal));
         ConstructorMap.Add("Vlan.notRelational", args => MkUserCnst(Network_Root.Vlan.UserCnstKind.notRelational));
         ConstructorMap.Add("Vlan.notTotal", args => MkUserCnst(Network_Root.Vlan.UserCnstKind.notTotal));
      }
      ...
      public enum TypeCnstKind
      {
         ...
         Interface,
         InterfaceEncap,
         InterfaceEncap_NDEX_0,
         InterfaceEncap_NDEX_1,
         ...
         SwitchPortTrunkAllowedVlan_NDEX_0,
         SwitchPortTrunkAllowedVlan_NDEX_1,
      ...
      public static readonly string[] TypeCnstNames =
      {
         ...
         "#SwitchPortTrunk",
         "#SwitchPortTrunkAllowedVlan",
         "#SwitchPortTrunkAllowedVlan[0]",
         "#SwitchPortTrunkAllowedVlan[1]",
         "#SwitchPortTrunk[0]",
         "#SwitchPortTrunk[1]",
         "#SwitchPort[0]",
         "#SwitchPort[1]",
      ...
      public static UserCnst MkUserCnst(Network_Root.Vlan.UserCnstKind val)
      {
         var n = new UserCnst();
         n.Value = val;
         return n;
      ...
      public static UserCnst MkUserCnst(Network_Root.Vlan.TypeCnstKind val)
      {
         var n = new UserCnst();
         n.Value = val;
         return n;
      ...
      public static Network_Root.Interface MkInterface(Network_Root.IArgType_Interface__0 id = null, Network_Root.IArgType_Interface__1 port = null, Network_Root.IArgType_Interface__2 encap = null)
      {
      ...
      public static Network_Root.InterfaceEncap MkInterfaceEncap(Network_Root.IArgType_InterfaceEncap__0 mode = null, Network_Root.IArgType_InterfaceEncap__1 vlan = null)
      {
         var _n_ = new Network_Root.InterfaceEncap();
         if (mode != null)
         {
            _n_.mode = mode;
         }
      ...
      public static Network_Root.SwitchPortTrunkAllowedVlan MkSwitchPortTrunkAllowedVlan(Network_Root.IArgType_SwitchPortTrunkAllowedVlan__0 iface = null, Network_Root.IArgType_SwitchPortTrunkAllowedVlan__1 vlan = null)
      {
         var _n_ = new Network_Root.SwitchPortTrunkAllowedVlan();
         if (iface != null)
         {
            _n_.iface = iface;
         }
      ...
      public static Network_Root._connects Mk_connects(Network_Root.IArgType__connects__0 src = null, Network_Root.IArgType__connects__1 dst = null, Network_Root.IArgType__connects__2 vlan = null)
      {
         var _n_ = new Network_Root._connects();
         if (src != null)
         {
            _n_.src = src;
         }
      ...
      public static Network_Root.connectVlan MkconnectVlan(Network_Root.IArgType_connectVlan__0 routerIface = null, Network_Root.IArgType_connectVlan__1 vlan = null)
      {
         var _n_ = new Network_Root.connectVlan();
         if (routerIface != null)
         {
            _n_.routerIface = routerIface;
         }
      ...
      public static Network_Root.connects Mkconnects(Network_Root.IArgType_connects__0 src = null, Network_Root.IArgType_connects__1 dst = null, Network_Root.IArgType_connects__2 vlan = null)
      {
         var _n_ = new Network_Root.connects();
         if (src != null)
         {
            _n_.src = src;
         }
      ...
      public static Network_Root.l2Edge Mkl2Edge(Network_Root.IArgType_l2Edge__0 src = null, Network_Root.IArgType_l2Edge__1 dst = null, Network_Root.IArgType_l2Edge__2 vlan = null)
      {
         var _n_ = new Network_Root.l2Edge();
         if (src != null)
         {
            _n_.src = src;
         }
      ...
      public static Network_Root.l2Path Mkl2Path(Network_Root.IArgType_l2Path__0 src = null, Network_Root.IArgType_l2Path__1 dst = null, Network_Root.IArgType_l2Path__2 vlan = null)
      {
         var _n_ = new Network_Root.l2Path();
         if (src != null)
         {
            _n_.src = src;
         }
      ...
      public static Network_Root.sameLan MksameLan(Network_Root.IArgType_sameLan__0 x = null, Network_Root.IArgType_sameLan__1 y = null, Network_Root.IArgType_sameLan__2 vlan = null)
      {
      ...
      public static Network_Root.trunkLink MktrunkLink(Network_Root.IArgType_trunkLink__0 x = null, Network_Root.IArgType_trunkLink__1 y = null, Network_Root.IArgType_trunkLink__2 native = null, Network_Root.IArgType_trunkLink__3 allowed = null)
      {
         var _n_ = new Network_Root.trunkLink();
         if (x != null)
         {
            _n_.x = x;
         }
      ...
      public static Network_Root.vlanDatabase MkvlanDatabase(Network_Root.IArgType_vlanDatabase__0 sw = null, Network_Root.IArgType_vlanDatabase__1 vlan = null, Network_Root.IArgType_vlanDatabase__2 iface = null, Network_Root.IArgType_vlanDatabase__3 mode = null)
      {
         var _n_ = new Network_Root.vlanDatabase();
         if (sw != null)
         {
            _n_.sw = sw;
         }
      ...
      public static Network_Root._CG_rel_CG_InterfaceEncap Mk_CG_rel_CG_InterfaceEncap(Network_Root.IArgType__CG_rel_CG_InterfaceEncap__0 arg_0 = null)
      {
         var _n_ = new Network_Root._CG_rel_CG_InterfaceEncap();
         if (arg_0 != null)
         {
            _n_._0 = arg_0;
         }
      ...
      public static Network_Root._CG_rel_CG_SwitchPortTrunkAllowedVlan Mk_CG_rel_CG_SwitchPortTrunkAllowedVlan(Network_Root.IArgType__CG_rel_CG_SwitchPortTrunkAllowedVlan__0 arg_0 = null)
      {
         var _n_ = new Network_Root._CG_rel_CG_SwitchPortTrunkAllowedVlan();
         if (arg_0 != null)
         {
            _n_._0 = arg_0;
         }
      ...
      public partial class AccessList :
         ...
         Network_Root.Vlan.Any,
         Network_Root.Vlan.Data
      {
      ...
      public partial class FrameRelayPort :
         ...
         Network_Root.IArgType_trunkLink__0,
         Network_Root.IArgType_trunkLink__1,
         Network_Root.Network.Any,
         Network_Root.Network.Data,
      ...
      public interface IArgType_Interface__2 :
         ICSharpTerm
      {
      }
      ...
      public partial class Interface :
         ...
         Network_Root.IArgType__connects__0,
         Network_Root.IArgType__connects__1,
         Network_Root.IArgType_connectVlan__0,
         Network_Root.IArgType_connects__0,
         Network_Root.IArgType_connects__1,
         ...
         Network_Root.Vlan.Data
      {
         ...
         private Network_Root.IArgType_Interface__2 _2_val = MkUserCnst(Network_Root.UserCnstKind.NIL);
         ...
         public Network_Root.IArgType_Interface__2 _2
         {
            get
            {
               Contract.Ensures(_2_val != null);
               return Get<Network_Root.IArgType_Interface__2>(() => _2_val);
            }
         ...
         public Network_Root.IArgType_Interface__2 encap
         {
            get
            {
               Contract.Ensures(_2_val != null);
      ...
      public interface IArgType_InterfaceEncap__0 :
         ICSharpTerm
      {
      }

      public interface IArgType_InterfaceEncap__1 :
         ICSharpTerm
      {
      }

      public partial class InterfaceEncap :
         GroundTerm,
         Network_Root.IArgType_Interface__2,
         Network_Root.IArgType__CG_rel_CG_InterfaceEncap__0,
         Network_Root.Network.Any,
         Network_Root.Network.Data,
         Network_Root.RouterConfiguration.Any,
         Network_Root.RouterConfiguration.Data,
         ...
         Network_Root.Vlan.Data
      {
         private Network_Root.IArgType_InterfaceEncap__0 _0_val = MkUserCnst(Network_Root.UserCnstKind.DOT1Q);
         private Network_Root.IArgType_InterfaceEncap__1 _1_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));

         public Network_Root.IArgType_InterfaceEncap__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType_InterfaceEncap__0>(() => _0_val);
            }
         ...
         public Network_Root.IArgType_InterfaceEncap__1 _1
         {
            get
            {
               Contract.Ensures(_1_val != null);
               return Get<Network_Root.IArgType_InterfaceEncap__1>(() => _1_val);
            }
         ...
         public Network_Root.IArgType_InterfaceEncap__0 mode
         {
            get
            {
               Contract.Ensures(_0_val != null);
         ...
         public Network_Root.IArgType_InterfaceEncap__1 vlan
         {
            get
            {
               Contract.Ensures(_1_val != null);
         ...
         public override int Arity { get { return 2; } }
         public override object Symbol { get { return "InterfaceEncap"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public partial class Switch :
         ...
         Network_Root.IArgType_device__1,
         Network_Root.IArgType_vlanDatabase__0,
         Network_Root.Network.Any,
         Network_Root.Network.Data,
         Network_Root.NetworkTopology.Any,
         Network_Root.NetworkTopology.Data,
      ...
      public partial class SwitchInterface :
         ...
         Network_Root.IArgType_SwitchPortTrunkAllowedVlan__0,
         Network_Root.IArgType__CG_rel_CG_SwitchInterface__0,
         Network_Root.IArgType__connects__0,
         Network_Root.IArgType__connects__1,
         Network_Root.IArgType_connects__0,
         Network_Root.IArgType_connects__1,
         Network_Root.IArgType_l2Edge__0,
         Network_Root.IArgType_l2Edge__1,
         Network_Root.IArgType_l2Path__0,
         Network_Root.IArgType_l2Path__1,
         Network_Root.IArgType_vlanDatabase__2,
         Network_Root.Network.Any,
         Network_Root.Network.Data,
         Network_Root.SwitchConfiguration.Any,
         Network_Root.SwitchConfiguration.Data,
      ...
      public interface IArgType_SwitchPortTrunkAllowedVlan__0 :
         ICSharpTerm
      {
      }

      public interface IArgType_SwitchPortTrunkAllowedVlan__1 :
         ICSharpTerm
      {
      }

      public partial class SwitchPortTrunkAllowedVlan :
         GroundTerm,
         Network_Root.IArgType__CG_rel_CG_SwitchPortTrunkAllowedVlan__0,
         Network_Root.Network.Any,
         Network_Root.Network.Data,
         Network_Root.SwitchConfiguration.Any,
         Network_Root.SwitchConfiguration.Data,
         ...
         Network_Root.Vlan.Data
      {
         private Network_Root.IArgType_SwitchPortTrunkAllowedVlan__0 _0_val = new Network_Root.SwitchInterface();
         private Network_Root.IArgType_SwitchPortTrunkAllowedVlan__1 _1_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));

         public Network_Root.IArgType_SwitchPortTrunkAllowedVlan__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType_SwitchPortTrunkAllowedVlan__0>(() => _0_val);
            }
         ...
         public Network_Root.IArgType_SwitchPortTrunkAllowedVlan__1 _1
         {
            get
            {
               Contract.Ensures(_1_val != null);
               return Get<Network_Root.IArgType_SwitchPortTrunkAllowedVlan__1>(() => _1_val);
            }
         ...
         public Network_Root.IArgType_SwitchPortTrunkAllowedVlan__0 iface
         {
            get
            {
               Contract.Ensures(_0_val != null);
         ...
         public Network_Root.IArgType_SwitchPortTrunkAllowedVlan__1 vlan
         {
            get
            {
               Contract.Ensures(_1_val != null);
         ...
         public override int Arity { get { return 2; } }
         public override object Symbol { get { return "SwitchPortTrunkAllowedVlan"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public interface IArgType__connects__0 :
         ICSharpTerm
      {
      }

      public interface IArgType__connects__1 :
         ICSharpTerm
      {
      }

      public interface IArgType__connects__2 :
         ICSharpTerm
      {
      }

      public partial class _connects :
         GroundTerm,
         Network_Root.Network.Any,
         Network_Root.Vlan.Any
      {
         private Network_Root.IArgType__connects__0 _0_val = new Network_Root.SwitchInterface();
         private Network_Root.IArgType__connects__1 _1_val = new Network_Root.SwitchInterface();
         private Network_Root.IArgType__connects__2 _2_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));

         public Network_Root.IArgType__connects__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType__connects__0>(() => _0_val);
            }
         ...
         public Network_Root.IArgType__connects__1 _1
         {
            get
            {
               Contract.Ensures(_1_val != null);
               return Get<Network_Root.IArgType__connects__1>(() => _1_val);
            }
         ...
         public Network_Root.IArgType__connects__2 _2
         {
            get
            {
               Contract.Ensures(_2_val != null);
               return Get<Network_Root.IArgType__connects__2>(() => _2_val);
            }
         ...
         public Network_Root.IArgType__connects__0 src
         {
            get
            {
               Contract.Ensures(_0_val != null);
         ...
         public Network_Root.IArgType__connects__1 dst
         {
            get
            {
               Contract.Ensures(_1_val != null);
         ...
         public Network_Root.IArgType__connects__2 vlan
         {
            get
            {
               Contract.Ensures(_2_val != null);
         ...
         public override int Arity { get { return 3; } }
         public override object Symbol { get { return "_connects"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public interface IArgType_connectVlan__0 :
         ICSharpTerm
      {
      }

      public interface IArgType_connectVlan__1 :
         ICSharpTerm
      {
      }

      public partial class connectVlan :
         GroundTerm,
         Network_Root.Network.Any,
         Network_Root.Vlan.Any
      {
         private Network_Root.IArgType_connectVlan__0 _0_val = new Network_Root.Interface();
         private Network_Root.IArgType_connectVlan__1 _1_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));

         public Network_Root.IArgType_connectVlan__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType_connectVlan__0>(() => _0_val);
            }
         ...
         public Network_Root.IArgType_connectVlan__1 _1
         {
            get
            {
               Contract.Ensures(_1_val != null);
               return Get<Network_Root.IArgType_connectVlan__1>(() => _1_val);
            }
         ...
         public Network_Root.IArgType_connectVlan__0 routerIface
         {
            get
            {
               Contract.Ensures(_0_val != null);
         ...
         public Network_Root.IArgType_connectVlan__1 vlan
         {
            get
            {
               Contract.Ensures(_1_val != null);
         ...
         public override int Arity { get { return 2; } }
         public override object Symbol { get { return "connectVlan"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public interface IArgType_connects__0 :
         ICSharpTerm
      {
      }

      public interface IArgType_connects__1 :
         ICSharpTerm
      {
      }

      public interface IArgType_connects__2 :
         ICSharpTerm
      {
      }
      ...
      public partial class connects :
         ...
         Network_Root.Vlan.Any
      {
         private Network_Root.IArgType_connects__0 _0_val = new Network_Root.SwitchInterface();
         private Network_Root.IArgType_connects__1 _1_val = new Network_Root.SwitchInterface();
         private Network_Root.IArgType_connects__2 _2_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));

         public Network_Root.IArgType_connects__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType_connects__0>(() => _0_val);
            }
         ...
         public Network_Root.IArgType_connects__1 _1
         {
            get
            {
               Contract.Ensures(_1_val != null);
               return Get<Network_Root.IArgType_connects__1>(() => _1_val);
            }
         ...
         public Network_Root.IArgType_connects__2 _2
         {
            get
            {
               Contract.Ensures(_2_val != null);
               return Get<Network_Root.IArgType_connects__2>(() => _2_val);
            }
         ...
         public Network_Root.IArgType_connects__0 src
         {
            get
            {
               Contract.Ensures(_0_val != null);
         ...
         public Network_Root.IArgType_connects__1 dst
         {
            get
            {
               Contract.Ensures(_1_val != null);
         ...
         public Network_Root.IArgType_connects__2 vlan
         {
            get
            {
               Contract.Ensures(_2_val != null);
         ...
         public override int Arity { get { return 3; } }
         public override object Symbol { get { return "connects"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public interface IArgType_l2Edge__0 :
         ICSharpTerm
      {
      }

      public interface IArgType_l2Edge__1 :
         ICSharpTerm
      {
      }

      public interface IArgType_l2Edge__2 :
         ICSharpTerm
      {
      }

      public partial class l2Edge :
         GroundTerm,
         Network_Root.Network.Any,
         Network_Root.Vlan.Any
      {
         private Network_Root.IArgType_l2Edge__0 _0_val = new Network_Root.SwitchInterface();
         private Network_Root.IArgType_l2Edge__1 _1_val = new Network_Root.SwitchInterface();
         private Network_Root.IArgType_l2Edge__2 _2_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));

         public Network_Root.IArgType_l2Edge__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType_l2Edge__0>(() => _0_val);
            }
         ...
         public Network_Root.IArgType_l2Edge__1 _1
         {
            get
            {
               Contract.Ensures(_1_val != null);
               return Get<Network_Root.IArgType_l2Edge__1>(() => _1_val);
            }
         ...
         public Network_Root.IArgType_l2Edge__2 _2
         {
            get
            {
               Contract.Ensures(_2_val != null);
               return Get<Network_Root.IArgType_l2Edge__2>(() => _2_val);
            }
         ...
         public Network_Root.IArgType_l2Edge__0 src
         {
            get
            {
               Contract.Ensures(_0_val != null);
         ...
         public Network_Root.IArgType_l2Edge__1 dst
         {
            get
            {
               Contract.Ensures(_1_val != null);
         ...
         public Network_Root.IArgType_l2Edge__2 vlan
         {
            get
            {
               Contract.Ensures(_2_val != null);
         ...
         public override int Arity { get { return 3; } }
         public override object Symbol { get { return "l2Edge"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public interface IArgType_l2Path__0 :
         ICSharpTerm
      {
      }

      public interface IArgType_l2Path__1 :
         ICSharpTerm
      {
      }

      public interface IArgType_l2Path__2 :
         ICSharpTerm
      {
      }

      public partial class l2Path :
         GroundTerm,
         Network_Root.Network.Any,
         Network_Root.Vlan.Any
      {
         private Network_Root.IArgType_l2Path__0 _0_val = new Network_Root.SwitchInterface();
         private Network_Root.IArgType_l2Path__1 _1_val = new Network_Root.SwitchInterface();
         private Network_Root.IArgType_l2Path__2 _2_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));

         public Network_Root.IArgType_l2Path__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType_l2Path__0>(() => _0_val);
            }
         ...
         public Network_Root.IArgType_l2Path__1 _1
         {
            get
            {
               Contract.Ensures(_1_val != null);
               return Get<Network_Root.IArgType_l2Path__1>(() => _1_val);
            }
         ...
         public Network_Root.IArgType_l2Path__2 _2
         {
            get
            {
               Contract.Ensures(_2_val != null);
               return Get<Network_Root.IArgType_l2Path__2>(() => _2_val);
            }
         ...
         public Network_Root.IArgType_l2Path__0 src
         {
            get
            {
               Contract.Ensures(_0_val != null);
         ...
         public Network_Root.IArgType_l2Path__1 dst
         {
            get
            {
               Contract.Ensures(_1_val != null);
         ...
         public Network_Root.IArgType_l2Path__2 vlan
         {
            get
            {
               Contract.Ensures(_2_val != null);
         ...
         public override int Arity { get { return 3; } }
         public override object Symbol { get { return "l2Path"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public interface IArgType_sameLan__2 :
         ICSharpTerm
      {
      }
      ...
      public partial class sameLan :
         ...
         Network_Root.Vlan.Any
      {
         private Network_Root.IArgType_sameLan__0 _0_val = new Network_Root.Interface();
         private Network_Root.IArgType_sameLan__1 _1_val = new Network_Root.Interface();
         private Network_Root.IArgType_sameLan__2 _2_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));
         ...
         public Network_Root.IArgType_sameLan__2 _2
         {
            get
            {
               Contract.Ensures(_2_val != null);
               return Get<Network_Root.IArgType_sameLan__2>(() => _2_val);
            }
         ...
         public Network_Root.IArgType_sameLan__2 vlan
         {
            get
            {
               Contract.Ensures(_2_val != null);
      ...
      public interface IArgType_trunkLink__0 :
         ICSharpTerm
      {
      }

      public interface IArgType_trunkLink__1 :
         ICSharpTerm
      {
      }

      public interface IArgType_trunkLink__2 :
         ICSharpTerm
      {
      }

      public interface IArgType_trunkLink__3 :
         ICSharpTerm
      {
      }

      public partial class trunkLink :
         GroundTerm,
         Network_Root.Network.Any,
         Network_Root.SwitchConfiguration.Any,
         Network_Root.Vlan.Any
      {
         private Network_Root.IArgType_trunkLink__0 _0_val = new Network_Root.FrameRelayPort();
         private Network_Root.IArgType_trunkLink__1 _1_val = new Network_Root.FrameRelayPort();
         private Network_Root.IArgType_trunkLink__2 _2_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));
         private Network_Root.IArgType_trunkLink__3 _3_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));

         public Network_Root.IArgType_trunkLink__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType_trunkLink__0>(() => _0_val);
            }
         ...
         public Network_Root.IArgType_trunkLink__1 _1
         {
            get
            {
               Contract.Ensures(_1_val != null);
               return Get<Network_Root.IArgType_trunkLink__1>(() => _1_val);
            }
         ...
         public Network_Root.IArgType_trunkLink__2 _2
         {
            get
            {
               Contract.Ensures(_2_val != null);
               return Get<Network_Root.IArgType_trunkLink__2>(() => _2_val);
            }
         ...
         public Network_Root.IArgType_trunkLink__3 _3
         {
            get
            {
               Contract.Ensures(_3_val != null);
               return Get<Network_Root.IArgType_trunkLink__3>(() => _3_val);
            }
         ...
         public Network_Root.IArgType_trunkLink__0 x
         {
            get
            {
               Contract.Ensures(_0_val != null);
         ...
         public Network_Root.IArgType_trunkLink__1 y
         {
            get
            {
               Contract.Ensures(_1_val != null);
         ...
         public Network_Root.IArgType_trunkLink__2 native
         {
            get
            {
               Contract.Ensures(_2_val != null);
         ...
         public Network_Root.IArgType_trunkLink__3 allowed
         {
            get
            {
               Contract.Ensures(_3_val != null);
         ...
         public override int Arity { get { return 4; } }
         public override object Symbol { get { return "trunkLink"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public interface IArgType_vlanDatabase__0 :
         ICSharpTerm
      {
      }

      public interface IArgType_vlanDatabase__1 :
         ICSharpTerm
      {
      }

      public interface IArgType_vlanDatabase__2 :
         ICSharpTerm
      {
      }

      public interface IArgType_vlanDatabase__3 :
         ICSharpTerm
      {
      }

      public partial class vlanDatabase :
         GroundTerm,
         Network_Root.Network.Any,
         Network_Root.SwitchConfiguration.Any,
         Network_Root.Vlan.Any
      {
         private Network_Root.IArgType_vlanDatabase__0 _0_val = new Network_Root.Switch();
         private Network_Root.IArgType_vlanDatabase__1 _1_val = MkNumeric(new Rational(BigInteger.Parse("0"), BigInteger.Parse("1")));
         private Network_Root.IArgType_vlanDatabase__2 _2_val = new Network_Root.SwitchInterface();
         private Network_Root.IArgType_vlanDatabase__3 _3_val = MkUserCnst(Network_Root.UserCnstKind.ACCESS);

         public Network_Root.IArgType_vlanDatabase__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType_vlanDatabase__0>(() => _0_val);
            }
         ...
         public Network_Root.IArgType_vlanDatabase__1 _1
         {
            get
            {
               Contract.Ensures(_1_val != null);
               return Get<Network_Root.IArgType_vlanDatabase__1>(() => _1_val);
            }
         ...
         public Network_Root.IArgType_vlanDatabase__2 _2
         {
            get
            {
               Contract.Ensures(_2_val != null);
               return Get<Network_Root.IArgType_vlanDatabase__2>(() => _2_val);
            }
         ...
         public Network_Root.IArgType_vlanDatabase__3 _3
         {
            get
            {
               Contract.Ensures(_3_val != null);
               return Get<Network_Root.IArgType_vlanDatabase__3>(() => _3_val);
            }
         ...
         public Network_Root.IArgType_vlanDatabase__0 sw
         {
            get
            {
               Contract.Ensures(_0_val != null);
         ...
         public Network_Root.IArgType_vlanDatabase__1 vlan
         {
            get
            {
               Contract.Ensures(_1_val != null);
         ...
         public Network_Root.IArgType_vlanDatabase__2 iface
         {
            get
            {
               Contract.Ensures(_2_val != null);
         ...
         public Network_Root.IArgType_vlanDatabase__3 mode
         {
            get
            {
               Contract.Ensures(_3_val != null);
         ...
         public override int Arity { get { return 4; } }
         public override object Symbol { get { return "vlanDatabase"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public interface IArgType__CG_rel_CG_InterfaceEncap__0 :
         ICSharpTerm
      {
      }

      public partial class _CG_rel_CG_InterfaceEncap :
         GroundTerm,
         Network_Root.Network.Any,
         Network_Root.RouterConfiguration.Any,
         Network_Root.Vlan.Any
      {
         private Network_Root.IArgType__CG_rel_CG_InterfaceEncap__0 _0_val = new Network_Root.InterfaceEncap();

         public Network_Root.IArgType__CG_rel_CG_InterfaceEncap__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType__CG_rel_CG_InterfaceEncap__0>(() => _0_val);
            }
         ...
         public override int Arity { get { return 1; } }
         public override object Symbol { get { return "~rel~InterfaceEncap"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public interface IArgType__CG_rel_CG_SwitchPortTrunkAllowedVlan__0 :
         ICSharpTerm
      {
      }

      public partial class _CG_rel_CG_SwitchPortTrunkAllowedVlan :
         GroundTerm,
         Network_Root.Network.Any,
         Network_Root.SwitchConfiguration.Any,
         Network_Root.Vlan.Any
      {
         private Network_Root.IArgType__CG_rel_CG_SwitchPortTrunkAllowedVlan__0 _0_val = new Network_Root.SwitchPortTrunkAllowedVlan();

         public Network_Root.IArgType__CG_rel_CG_SwitchPortTrunkAllowedVlan__0 _0
         {
            get
            {
               Contract.Ensures(_0_val != null);
               return Get<Network_Root.IArgType__CG_rel_CG_SwitchPortTrunkAllowedVlan__0>(() => _0_val);
            }
         ...
         public override int Arity { get { return 1; } }
         public override object Symbol { get { return "~rel~SwitchPortTrunkAllowedVlan"; } }
         public override ICSharpTerm this[int index]
         {
            get
            {
      ...
      public partial class RealCnst :
         ...
         Network_Root.IArgType_InterfaceEncap__1,
         ...
         Network_Root.IArgType_SwitchPortTrunkAllowedVlan__1,
         ...
         Network_Root.IArgType__connects__2,
         Network_Root.IArgType_connectVlan__1,
         Network_Root.IArgType_connects__2,
         Network_Root.IArgType_l2Edge__2,
         Network_Root.IArgType_l2Path__2,
         Network_Root.IArgType_sameLan__2,
         Network_Root.IArgType_trunkLink__2,
         Network_Root.IArgType_trunkLink__3,
         Network_Root.IArgType_vlanDatabase__1,
         Network_Root.ID,
      ...
      public partial class Quotation :
         ...
         Network_Root.IArgType_IP__0,
         Network_Root.IArgType_IgmpOptions__0,
         Network_Root.IArgType_InterfaceEncap__0,
         Network_Root.IArgType_InterfaceEncap__1,
         Network_Root.IArgType_InterfaceIpAccessGroup__0,
         Network_Root.IArgType_InterfaceIpAccessGroup__1,
         ...
         Network_Root.IArgType_vlanDatabase__1,
         Network_Root.IArgType_vlanDatabase__2,
         Network_Root.IArgType_vlanDatabase__3,
         Network_Root.ID,
         ...
         Network_Root.Vlan.Data
      {
         ...
         private static bool ValidateType(object o)
         {
            ...
            else if (o is Network_Root.Vlan.UserCnstKind)
            {
               return true;
            }
            else if (o is Network_Root.Vlan.TypeCnstKind)
            {
               return true;
            }
            else
         ...
         private static string ToSymbol(object o)
         {
            ...
            {
               return Network_Root.Vlan.UserCnstNames[(int)o];
            }
            else if (o is Network_Root.Vlan.TypeCnstKind)
            {
               return Network_Root.Vlan.TypeCnstNames[(int)o];
            }
            else
            {
               throw new InvalidOperationException();
      ...
      public static partial class Vlan
      {
         ...
         public static string Namespace { get { return "Vlan"; } }
         public interface Any :
            ICSharpTerm
         {
         }
